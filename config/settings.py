...
SECRET_KEY = 'django-insecure-+&w6h3zxamp-o&(_1zi#9(-nar=z*6*pd0unazqmor)!wi=dha'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [
    "ijunavi.onrender.com",
    ".onrender.com",
    "localhost",
    "127.0.0.1",
]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER', 'ijunavi@gmail.com')
